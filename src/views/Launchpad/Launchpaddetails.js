                ...
                <div className="row bg-color-raffle">
                    <div className="col-xl-8 col-12">
                        <div className="addraffles">
                            ...
                            <div className='imgslablrtop'>
                                <label for="exampleInputsymbol"> Image</label>
                                <div class="form-group rightside-for-group">
                                    <label for="exampleInputsymbol">Banner Preview Image</label>
                                    <div className="main-image-div">
                                        <div className="choose-filessss">
                                            <form>  <input type="file" name="image" className={'form-control onlyforchosefiles'} accept="image/*" />
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group rightside-for-group">
                                    <label for="exampleInputsymbol">Detail Page Image</label>
                                    <div className="main-image-div">
                                        <div className="choose-filessss">
                                            <form>  <input type="file" name="image" className={'form-control  onlyforchosefiles'} accept="image/*" />
                                            </form>
                                ...
                                {/* <div class="form-group rightside-for-group">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <div class="input-group-prepend">
                                            <button class="btn btn-outline-secondary" type="file"  id="button-addon1">Choose File</button>
                                        </div>
                                ...
                                <div class="form-group rightside-for-group">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <div class="input-group-prepend">
                                            <button class="btn btn-outline-secondary" type="button" id="button-addon1">Choose File</button>
                                        </div>
                            ...
                            <div className="option-field">
                                ...
                                <input value={raffelCat?.totalTickets} onChange={addRaffel} name='totalTickets' type="number" placeholder='Max Supply' />
                                {error && (!(raffelCat?.totalTickets === '') ? null : <p className="text-danger">Max Supply is missing!</p>)}
                            </div>
                            <div className="option-field">
                            ...
                            <div className='twice-field'>
                                <div className="option-field">
                                    <label>Price</label>
                                    <input value={raffelCat?.totalTickets} onChange={addRaffel} name='totalTickets' type="number" placeholder='Max Supply' />
                                    {error && (!(raffelCat?.totalTickets === '') ? null : <p className="text-danger">Price missing!</p>)}
                                </div>
                                <div className="option-field">
                                    <label>Price paid in which token</label>
                                    <input value={raffelCat?.pricePerTicket} onChange={addRaffel} name='pricePerTicket' type="number" placeholder='Price per ticket' />
                                    {error && (!(raffelCat?.pricePerTicket === '') ? null : <p className="text-danger">Price paid in which token</p>)}
                                </div>
                            </div>
                            <div class="form-group rightside-for-group">
                                <label for="exampleInputsymbol">Banner Preview Image</label>
